...
obj/items/wearable/proc/Equip(var/mob/Player/owner)
	...
	if(src in owner.Lwearing)
		...
		if(showoverlay)
			var/obj/o = new
			o.icon = src.icon
			if(typesof(/obj/items/wearable/wigs)) o.icon_state = owner.Gender
			o.layer = wear_layer
			owner.overlays -= o
		suffix = null
		UpdateDisplay()
...
//NEW//
obj/items/wearable/wigs/black_wig
	icon = 'black_wig.dmi'
obj/items/wearable/wigs/blond_wig
	icon = 'blond_wig.dmi'
obj/items/wearable/wigs/brown_wig
	icon = 'brown_wig.dmi'
obj/items/wearable/wigs/cyan_wig
	icon = 'cyan_wig.dmi'
obj/items/wearable/wigs/christmas_wig
	icon = 'christmas_wig.dmi'
obj/items/wearable/wigs/darkblue_wig
	icon = 'darkblue_wig.dmi'
obj/items/wearable/wigs/darkpink_wig
	icon = 'darkpink_wig.dmi'
obj/items/wearable/wigs/darkpurple_wig
	icon = 'darkpurple_wig.dmi'
obj/items/wearable/wigs/green_wig
	icon = 'green_wig.dmi'
obj/items/wearable/wigs/grey_wig
	icon = 'grey_wig.dmi'
obj/items/wearable/wigs/halloween_wig
	icon = 'halloween_wig.dmi'
obj/items/wearable/wigs/lightblue_wig
	icon = 'lightblue_wig.dmi'
obj/items/wearable/wigs/lightpink_wig
	icon = 'lightpink_wig.dmi'
obj/items/wearable/wigs/lightpurple_wig
	icon = 'lightpurple_wig.dmi'
obj/items/wearable/wigs/orange_wig
	icon = 'orange_wig.dmi'
obj/items/wearable/wigs/red_wig
	icon = 'red_wig.dmi'
obj/items/wearable/wigs/silver_wig
	icon = 'silver_wig.dmi'
obj/items/wearable/wigs/teal_wig
	icon = 'teal_wig.dmi'
obj/items/wearable/wigs/yellow_wig
	icon = 'yellow_wig.dmi'
